...
<template>
  <div
    class="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-4">
    <div class="w-80 h-[600px] md:w-96 md:h-[650px] lg:w-[420px] lg:h-[700px] relative">
      <!-- Background Glass Effect -->
      <div
        class="w-full h-full absolute inset-0 bg-gradient-to-bl from-teal-300/30 to-white/0 rounded-[10px] backdrop-blur-[2px] border border-white/20 shadow-xl">
      </div>
