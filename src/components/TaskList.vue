...
<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900 transition-colors duration-300">
    <!-- Header -->
    <header class="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md shadow-lg border-b border-white/20 dark:border-gray-700/20 sticky top-0 z-50">
      <div class="max-w-7xl mx-auto px-6 py-4">
        <div class="flex justify-between items-center">
          ...
          <div class="flex items-center space-x-4">
            ...
            <!-- User Profile -->
            <div class="flex items-center space-x-3 px-4 py-2 bg-white/60 dark:bg-gray-700/60 rounded-xl border border-gray-200 dark:border-gray-600 shadow-sm">
    ...
    <main class="max-w-7xl mx-auto px-6 pb-12">
      <!-- Loading State -->
      <div v-if="tasksStore.isLoading" class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-12 text-center border dark:border-gray-700">
      ...
      <!-- Error State -->
      <div v-else-if="tasksStore.error" class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6">
      ...
      <div v-else-if="taskCount > 0" class="space-y-6">
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="3"
                  class="w-full px-3 py-2 border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm resize-none"
                ></textarea>
              </div>
            </div>
        ...
        <div v-if="tasksStore.setSearchQuery || tasksStore.setStatusFilter" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border dark:border-gray-700 p-6">
        ...
        <div v-if="tasksStore.filteredTasks && tasksStore.filteredTasks.length === 0" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8 text-center border dark:border-gray-700">
